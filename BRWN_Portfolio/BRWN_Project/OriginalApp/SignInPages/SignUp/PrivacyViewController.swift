...
class PrivacyViewController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        // ボタンの装飾
        consentButton2.center = self.view.center
        consentButton2.backgroundColor = #colorLiteral(red: 0.251144737, green: 0.1601424813, blue: 0.1088011637, alpha: 1) // 3
        consentButton2.setTitleColor(#colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0), for: .normal)
        //consentButton2.layer.borderWidth = 4
        //consentButton2.layer.borderColor = #colorLiteral(red: 0.930855453, green: 0.8780241609, blue: 0.8337224126, alpha: 1)
        consentButton2.layer.cornerRadius = 25
